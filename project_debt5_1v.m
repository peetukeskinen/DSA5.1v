...
function [debt_out,g_out,drgdp_out,iir_out,pb_out,spb_out,ob_out,sb_out,rgdp_out]=project_debt5_1v(...
    scenario, adjustment, iir, potgdp, og, epsilon,m,dcoa,dprop,sfa,inflation,rgdp_initial,debt_initial,...
    alpha_initial,beta_initial,spb,i_st,i_lt,m_lt,pb,ob,sb,stoch_method,g_shock,pb_shock,iir_shock,adj_periods,theta_lt)
